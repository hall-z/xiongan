...
<template>
  <view class="w-100vw h-100vh dy-blue-bg box-border overflow-y-auto pb-100px">
        ...
        <wd-form ref="form" :model="model">
          <wd-cell-group border>
            ...
            <wd-input
              ...
              label-width="70px"
              prop="feedbackPhone"
              :rules="rules.feedbackPhone"
              custom-label-class="font-600"
              clearable
              v-model="model.feedbackPhone"
              placeholder="请输入联系电话"
            />
          </wd-cell-group>
        </wd-form>
    ...
    <view class="px-35px py-21px box-border fixed bottom-0 left-0 right-0 bg-#fff safe-area-after">
      <wd-button block :round="false" @click="submit(form)" custom-class="bg-#2D69EF">提 交</wd-button>
    </view>
  </view>
</template>

<template>
  ...
  >
    ...
    <image class="coupon-item-bg" v-if="couponStatus == 'unable'" :src="cardbg4"></image>
    <image
      class="coupon-item-bg"
      v-else-if="couponStatus == 'enable' && selectedSelf"
      :src="cardbg5"
    ></image>

<template>
  ...
  <view class="top-info container" @click.stop="toggleOfficialPopup" v-if="state.loaded">
    ...
    >
      ...
      ></image>
      <view>请输入搜索关键词</view>
      <view :style="'background-color: ' + state.theme.color + ';'" class="search-btn">搜索</view>
  ...
  <view v-else class="top-search-box">
    ...
    <view class="topHandleView">
      <view class="index-search-box"></view>
...
onMounted(function () {
  state.titlebarBackgroundColour =
    app.globalData.systemConfigure && app.globalData.systemConfigure.titlebarBackgroundColour
  state.titlebarFotColour =
    app.globalData.systemConfigure && app.globalData.systemConfigure.titlebarFotColour
  state.homeBackgroundColour =
    app.globalData.systemConfigure && app.globalData.systemConfigure.homeBackgroundColour
  state.homeBackgroundImage =
    app.globalData.systemConfigure && app.globalData.systemConfigure.homeBackgroundImage
...
function reload(refresh = false) {
  ...
  if (!state.loaded) {
    lazyLoadBase
      .determineComponentInVisibleArea('.top-search-box', that)
      .then((res) => {
        console.log(res)
        if (res) {
          state.loaded = true

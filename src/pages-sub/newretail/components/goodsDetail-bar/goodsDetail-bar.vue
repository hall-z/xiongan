...
<weui-navigation-bar :loading="loading" :show="show" :animated="animated" :color="color" style="position: fixed; z-index: 90" :title="title" :back="back">
  <view slot="left" :class="'left-navigation-bar-box ' + (hideBack ? 'no-back' : '')" v-if="!isTabbar">
...
attached(function () {
  ...
  if (pagePath === "/pages-sub/newretail/pages/wxfaceapp/index/index" || pagePath === "/pages-sub/newretail/pages/wxfaceapp/payment/payment") {
    state.isTabbar = true;
  }

    ...
    <view class="rounded-10px overflow-hidden bg-#fff formView">
      ...
      <view class="pt-20px">
        <wd-form ref="formPhoto" :model="modelPhoto">
          <view class="mb-20px" @click="upload('3', '2')">
            <Card-Upload :type="3" :imgUrl="dbrCardUrl" />
          </view>
          <view @click="upload('4', '2')">
      ...
      <wd-form ref="form" :model="model">
        <wd-cell-group border>
          ...
          <wd-cell required title="家庭住址" title-width="100px">
            <text custom-class="custom-value">{{ model.mailAddress }}</text>
          </wd-cell>
...
import useCardJuvenBhk from '../hooks/useCardJuvenBhk'
import {
  applicantList,
  businessTypeList,
  cardType,
...
import { modelOther } from '@/pages-sub/serveMain/hooks/lifespan'
